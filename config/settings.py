...
ONBOARDING_BROKER_FUNCTION = os.environ.get('ONBOARDING_BROKER_FUNCTION', '')
ONBOARDING_LOCK_FILE = os.environ.get('ONBOARDING_LOCK_FILE', '/run/cloud-billing-activation/lock')
